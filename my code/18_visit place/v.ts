...
let VisitPlace:string[]=["Palestine", "Turki", "Amrica", "Suidia Arab", "Iraan"];
...
console.log("Revers Alphabatical order           :", [...VisitPlace].sort().reverse());
...
console.log("Stored in Revers Alphabatical Order :",  [...VisitPlace].sort().reverse());
